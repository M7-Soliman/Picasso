...
public class SemanticAnalyzer implements SemanticAnalyzerInterface {
	...
	private SemanticAnalyzer() {
		...
		// Assignment mapping
		tokenName = TOKENS_PACKAGE_NAME + "AssignmentToken";
		parserName = PARSER_PACKAGE + "AssignmentAnalyzer";
		addSemanticAnalyzerMapping(tokenName, parserName);
	...
	private void addSemanticAnalyzerMapping(String tokenName, String semanticAnalyzerName) {
		...
		try {
			...
			//Class.forName(semanticAnalyzerName).getDeclaredConstructor(ExpressionTreeNode.class).newInstance(parameter);
		} catch (ClassNotFoundException e) {
